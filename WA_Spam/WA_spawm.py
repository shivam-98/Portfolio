...
driver=webdriver.Chrome("Downloads/chromedriver") #Enter Location of Chrome driver
driver.maximize_window()
driver.get("https://web.whatsapp.com/")
sleep(15)
driver.find_element_by_xpath("/html/body/div/div/div/div/div/div/div[1]/div/div/div[1]/div/div/div").click()
sleep(5)
fileLocation= "Downloads/Joker_script.docx"  #Enter location of movie script file
